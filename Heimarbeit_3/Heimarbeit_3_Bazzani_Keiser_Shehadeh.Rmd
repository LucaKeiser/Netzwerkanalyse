...
Zuerst wurden die Masszahlen für Grösse, Dichte, Komponenten, Durchmesser und Clostering berechnet (Abb. 1). Beim Netzwerk handelt es sich jeweils um eine Komponente, auch wenn die innerparteilichen Edges wegfallen. Somit sehen wir, dass die Parlamentarier: innen überparteilich durch die Lobbyorganisationen miteinander verbunden sind. Die Dichte des Netzwerkes ist bei einem Score von 0.1022057 (ratiorange 0-1) eher gering Je näher zur 1 desto grösser wäre das Netzwerk miteinander verbunden (Luke 2015: 26). 
