...
Das ganze Organisationsnetzwerk ist viel zu gross. Es kann anhand meherer Kriterien gefiltert werden (Ort, Branche, Zentralitätsmasse etc.). Hier werden zuerst Kanten entfernt, welche eine Gewichtung <= 1 aufweisen. Das heisst, es werden nur
...
In einem zweiten Netzwerkgraphen werden Organistaionen entfernt, welche ein Degree von < 35 aufweisen.
...
erg_model <- erdos.renyi.game(net_nodes,
                              net_dens,
                              type='gnp')
...
kable(df_model, caption = "Table 4: Model comparison empirical network vs. modelled networks")
